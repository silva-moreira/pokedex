/** abrir informações quando o pokémon da lista for clicado*/
...
/**atualize a imagem do Pokémon e ajuste a altura para diferentes dimensões do sprite ---> (para posicionar diretamente acima das informações)*/
...
/**configurar id do pokémon, nome, tipos, altura, peso e descrição */
function setupPokemonAbout(pokemon, id, species) {
    ...
    for(i = 0; i < species.flavor_text_entries.length; i++) {
        if(species.flavor_text_entries[i].language.name == ''){
...
/**configurar estatísticas do pokémon */
...
/**configurar habilidades do pokémon */
...
/**configurar cadeia de evolução (todas as 3 evoluções)*/
...
/**configurar imagens e nível de evolução*/
...
/**tornar o contêiner do Pokémon atual visível após redimensionar para <1100px de largura && mostrar a barra de rolagem*/
